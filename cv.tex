...
\begin{flushright}
\href{https://drive.google.com/file/d/1jmPwFzCnq9RVce5ohDJJBwbIS_fXxH93/view?usp=sharing}{\footnotesize \faRefresh $\;$ Last Updated \today}\\[0em]
\end{flushright}
\end{textblock}
...
\aside{about}{0.4}{
    ...
    \mbox{and their impact on galaxy }
    \mbox{evolution, and 3) improving}
    \mbox{models of subgrid physics in  }
    \mbox{galaxy simulations.}
    }
...
\aside{code}{-2.5}{
%\vspace*{0.5em}
\texttt{enzo} \hfill {\footnotesize 2014 -- 2020} \\
...
\texttt{ChaNGa} \hfill {\footnotesize 2015 -- 2020}\\
\begin{list}{{\footnotesize $+$}}{\asidelist}
...
\aside{students}{0.05}{
    ...
    \textbf{Shreya Nakum}\\
    {\footnotesize MAGIC, 2018-2019}\\[0.5em]
    ...
    \textbf{Eliana Sisman}\\
    {\footnotesize MAGIC, 2017-2018}\\[0.5em]
...
\vspace{-1em}
\begin{list}{$+$}{\cvlist}
%\item ASTR 101, ``The Evolving Universe'' \hfill {\footnotesize Spring 2019}
...
\aside{references}{-2}{
    ...
    \textbf{Philip Hopkins}\\
    {\footnotesize phopkins@caltech.edu}
    
    \textbf{Daisuke Nagai}\\
    {\footnotesize daisuke.nagai@yale.edu}
}
\fi
